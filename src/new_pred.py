...
class Act_pos_forecasting(pl.LightningModule):
    def __init__(self, window=10, input_size=10, hidden_size=256,
        ...
        self.act_autoencoder = self.act_forecast.load_from_checkpoint(act_path_autoencoder)
    ...
    def forward(self, x):
        ...
        encode = self.pos_autoencoder.encoding(x_copy)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log_dict({ 'val/loss/general_loss_pos': general_loss, 
